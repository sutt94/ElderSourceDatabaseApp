...
namespace ElderSourceApp.Controllers
{
    public class CompanyController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CompanyModelID,CompanyName,City,State,ZipCode,CompanyType,Phone,HasSymbol,EmployeesTrained,HasPolicies,HasDeclaration,InArrears")] CompanyModel companyModel)
        {
